...
export const CreateCard = ( {
  ...
  return ( <StyledCreateCardContainer appView={ appView } visible={ visible }>
...
const StyledCreateCard = styled.div`
  width: 100%;
  height: 90%;
  border: ${ props => props.highlighted ? "2px solid #4CB69F" :
  "2px solid #908a7d" };
  ${ props => props.appView === APP_VIEW_DESKTOP ?
  "border: 1px solid #36405C;" : "" }
  border-radius: ${ props => props.appView === APP_VIEW_MOBILE ? "4px" :
  "10px" };
  display: flex;
  ${ props => props.appView === APP_VIEW_DESKTOP ? "flex-direction: column;" :
  "" }
