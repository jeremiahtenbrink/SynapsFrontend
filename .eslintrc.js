module.exports = {
  env: {
    ...
    "react/prop-types": "off", "space-in-brackets": [ "off", "always" ],
  }, settings: {
    react: {
      ...
      // version you have installed. You can also use
      // `16.0`, `16.3`, etc, if you want to override the
      // detected value. default to latest and warns if
      // missing It will default to "detect" in the future
      ...
      "forbidExtraProps", { property: "freeze", object: "Object" },
